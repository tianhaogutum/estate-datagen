...
from version_bk.data_synthesizer import synthesize_to_file
from version_bk.doc_generator import generate_document
from version_bk.taxonomy import REAL_ESTATE_TAXONOMY, SYSTEM_TYPES
...
def run(doc_key: str, system_key: str, use_few_shots: bool = True) -> None:
    ...
    out_dir = (
        ...
        / "output"
        / f"{doc_key}_{system_key}_{style_names}_{timestamp}"
    )
